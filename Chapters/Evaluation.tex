...
[I learned that CS-Benchmark uses the metrics file of the VanValen-Lab. so...i'll change some citations primarily my code] in the in the future to indicate it's from deepcell-toolbox and not from cs-benchmark.
\begin{figure}
    \centering
...
\begin{table}[H]
    \centering
    \caption{CellSegmentationEvaluation. Results for Mesmer, segger and Xenium.}
