...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \label{fig:seg_cross}
    \end{subfigure}
    \caption{The results of the evaluation using \inlineprogram{XenSegEval.eval.base}, and the \inlineprogram{DT} package. (a) presents the count (left) and relative area $\frac{SR}{GT}$ (right) for all segmentations. (b) to (d) show the cross-evaluation for the metrics Jaccard (b), F1 (c) and SEG (d).}
    \label{fig:results}
\end{figure*}
