...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.422\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Images/SI/area_bars_no_legend.pdf}
        \caption{}
        \label{fig:CA_bars}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.422\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Images/SI/jaccard_dc_cross_evaluation_newmem_fonts.pdf}
        \caption{}
        \label{fig:ji_cross}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Images/SI/f1_dc_cross_evaluation_newmem_fonts.pdf}
        \caption{}
        \label{fig:f1_cross}
    \end{subfigure}
    ~
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Images/SI/seg_dc_cross_evaluation_newmem_fonts.pdf}
        \caption{}
        \label{fig:seg_cross}
    \end{subfigure}
    \caption{The results of the evaluation using \inlineprogram{XenSegEval.eval.base}, and the \inlineprogram{DT} package. (a) presents the count (left) and relative area $\frac{SR}{X \cdot Y}$ (right) for all segmentations. (b) to (d) show the cross-evaluation for the metrics Jaccard (b), F1 (c) and SEG (d).}
    \label{fig:results}
\end{figure*}

\subsection*{Panel}
% \newpage
% \input{data/Xenium_mMulti_v1_metadata_JS_final 1(sortiert nach Organ)}
% \newpage
\input{data/formated_Xenium_mMulti_v1_metadata_JS_final 1(additional genes_explanation)}
\newpage